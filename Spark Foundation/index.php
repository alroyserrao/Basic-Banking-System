...
<head>
    ...
    <title>Welcome to FCRIT Bank</title>
...
<div id="container">
        ...
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to <br> FCRIT
                        Bank!</b></p>
            </div>
            <div class="col" style="margin:0% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="statics/bank.png" class="zoomin" alt="" style="height:400px; width:0px;">
            </div>
        </div>
    </div>
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            ...
            <h1 style="text-shadow:2px 2px 2px gray; color:white;"><b>Our Customers</b></h1>
                ...
                <div class="row">
                    ...
                    <div class="col-lg">
                        <div
                            ...
                            <a href="send_money.php"><button type="button" class="btn btn-outline-light mybtn"> Money Transfer </button></a><br>
